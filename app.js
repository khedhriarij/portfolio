...
// Remplacer l'animation d'écriture existante
typewriter 
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est <strong>Arij KHEDHRI</strong>')
.pauseFor(300)
.typeString('<strong>, Développeuse Full-Stack</strong> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #27ae60;"> Spring Boot</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #EA39ff;"> Angular</span> !')
.pauseFor(1000)
.deleteChars(9)
.typeString('<span style="color: midnightblue;"> IA/ML</span> !')
.pauseFor(1000)
.deleteChars(7)
.typeString('<span style="color: #ff6910;"> Power BI</span> !')
.start()
